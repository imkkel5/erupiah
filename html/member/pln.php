      ...
      <div class="row">
        <div class="col-xs-12 col-md-12">
          <div class="section-container-spacer">
            <h2  class="text-center">pembayaran listrik</h2>
                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="form-group">
                      <input type="text" class="form-control" id="nomor meter" placeholder="nomor meter PLN">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" id="nominal" placeholder="nominal yang dibayarkan Rp.">
                    </div>
