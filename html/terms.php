  ...
  <div class="hero-caption">
    <div class="container fg-white h-100">
      <div class="row justify-content-center align-items-center text-center h-100">
        <div class="col-lg-6">
          <h3 class="mb-4 fw-medium">Syarat dan ketentuan website E-Rupiah</h3>
    ...
    <div class="row">
      <div class="col-lg-4 py-3">
        <div class="iconic-list">
          ...
          <div class="iconic-item wow fadeInUp">
            <div class="iconic-content">
              <h5>Perlindungan E-Rupiah</h5>
              <p class="fs-small">bentuk perlindungan diberikan kepada serangan atau tindakan peretasan terhadap akun E-Rupiah, serta melindungi transaksi pengguna dari transaksi tidak sah</p>
            </div>
      ...
      <div class="col-lg-4 py-3">
        <div class="iconic-list">
          <div class="iconic-item wow fadeInUp">
            ...
            <div class="iconic-content">
              <h5>Jangka waktu</h5>
              <p class="fs-small">akun E-Rupiah milik pengguna akan berlaku selama akun tersebut tidak ditutup secara permanen oleh pengguna ataupun pihak E-Rupiah</p>
            </div>
          </div>
          <div class="iconic-item wow fadeInUp">
            ...
            <div class="iconic-content">
              <h5>Transaksi</h5>
              <p class="fs-small">transaksi hanya dapat berjalan apabila saldo E-Rupiah pengguna mencukupi</p>
            </div>
          </div>
        </div>
      </div>
