    ...
    <div class="container h-100">
      <div class="row align-items-center h-100">
        <div class="col-lg-6 wow fadeInUp">
          <h1 class="mb-4">Kami Akan selalu ada untuk Anda.</h1>
          <p class="mb-4">Miliki manager keuangan sekaligus dompet digital premium tanpa Ribet <br>
          our finances, such as transfer, and statistics.</p>
          <a href="Register-Form.php" class="btn btn-primary rounded-pill">Daftar Sekarang</a>
        </div>
...
<div class="page-section bg-dark fg-white">
  <div class="container">
    <h1 class="text-center">Kenapa Harus Memilih E-Rupiah</h1>
    ...
    <div class="row justify-content-center mt-5">
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn">
          ...
          <p class="fs-small fg-grey">Layanan menggunakan koneksi 5G di seluruh Indonesia</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="200ms">
          ...
          <p class="fs-large">Kepuasan Pengguna</p>
          <p class="fs-small fg-grey">Kepuasan Anda akan layanan kami adalah jaminan</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="400ms">
          ...
          <p class="fs-large">Bebas Iklan</p>
          <p class="fs-small fg-grey">Bosan menghadapi Iklan?, Ini solusinya</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="600ms">
          ...
          <p class="fs-large">Ahli Keuangan</p>
          <p class="fs-small fg-grey">Kami sebagai manager keuangan Anda</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="800ms">
          ...
          <p class="fs-large">Dukungan Layanan</p>
          <p class="fs-small fg-grey">Layanan dengan jam libur 0%</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="1000ms">
          ...
          <p class="fs-large">Fitur Terlengkap</p>
          <p class="fs-small fg-grey">Hadir bagi Anda untuk menjawab kebutuhan Anda</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container fg-white">
    <div class="row">
      <div class="col-md-8 col-lg-6 offset-lg-1 wow fadeInUp">
        <h2 class="mb-5 fg-white fw-normal">Cerita Sahabat E-Rupiah </h2>
        <p class="fs-large font-italic">E-Rupiah memudahkan saya membeli perlengkapan untuk mendaki, dengan bonus yang diberikan seperti cashback yang bisa saya dapatkan setiap minggunya.</p>
        <p class="fs-large fg-grey fw-medium mb-5">Utok,</p>
        <p class="fs-large fg-grey fw-medium">Mahasiswa | 19 tahun</p>

        <a href="#" class="btn btn-outline-light rounded-pill">Testimoni Lainnya <span class="mai-chevron-forward"></span></a>
      </div>
    </div>
  </div>
</div>
