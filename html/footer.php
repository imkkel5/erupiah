  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6 py-2">
        <img src="../assets/img/icons/LOGO2.png" alt="" width="40">
        <!-- Please don't remove or modify the credits below -->
        <p class="d-inline-block ml-2">Copyright &copy; <a href="#" class="fg-white fw-medium">E-Rupiah</a>. All rights reserved</p>
      </div>
      <div class="col-12 col-md-6 py-2">
